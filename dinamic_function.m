function q_dd = dinamic_function(tau, theta_1, theta_2, theta_1_d, theta_2_d, a_1, a_2, m_1, m_2)
    ...
    I = [...
        inertia(m_1, a_1) 0;...
        inertia(m_1, a_1) inertia(m_2, a_2);...
        ];
    ...
    g = [m_1*g*a_1*0.5*cos(theta_1)+m_2*g*a_2*0.5*cos(theta_1+theta_2);m_2*g*a_2*0.5*cos(theta_1+theta_2)];
...
function D = d_matrix(theta_1, theta_2, a_1, a_2)
    D = [...
        ...
        a_1*0.5*cos(theta_1)+a_2*0.5*cos(theta_1+theta_2) a_2*0.5*cos(theta_1+theta_2);...
        ];
end 
...
function E = e_matirx(theta_1, theta_2, theta_1_d, theta_2_d, a_1, a_2)
    E = [...
        ...
        -a_1*0.5*cos(theta_1)*theta_1_d-a_2*0.5*cos(theta_1+theta_2)*theta_1_d -a_2*0.5*cos(theta_1+theta_2)*theta_2_d-a_2*0.5*cos(theta_1+theta_2)*2*theta_1_d;...
        -a_1*0.5*sin(theta_1)*theta_1_d-a_2*0.5*sin(theta_1+theta_2)*theta_1_d -a_2*0.5*sin(theta_1+theta_2)*theta_2_d-a_2*0.5*sin(theta_1+theta_2)*2*theta_1_d;...
        ];
end